...
public class SpaTypeListViewAdapterNew extends BaseExpandableListAdapter {
    ...
    public SpaTypeListViewAdapterNew(Context context, SparseArray<List<SpaItemInfo>> dataset, List<SpaDataInfo> spaDataInfos) {
