...
public class LoginGroupActivity extends BaseActivity<LoginGroupPresenter> implements LoginContract.View {
    ...
    @Override
    public void init() {
        mLoginPresenter = new LoginGroupPresenter(this, this);
        initViews();
    }
}
