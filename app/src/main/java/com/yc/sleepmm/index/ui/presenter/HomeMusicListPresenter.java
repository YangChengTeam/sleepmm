...
public class HomeMusicListPresenter extends RxPresenter<HomeMusicListContract.View> implements HomeMusicListContract.Presenter<HomeMusicListContract.View> {
    ...
    public void getMusicList(String musicID, int page, int pageSize) {
        ...
        HttpCoreEngin.get(mContext).rxpost("http://sc.wk2.com/Api/Appnq6/music_recommend", MediaMusicCategoryList.class, params, false, false, false).observeOn(AndroidSchedulers.mainThread()).subscribe(new Action1<MediaMusicCategoryList>() {
            @Override
